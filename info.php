...
if(!isset($_SESSION['user'])){
    echo "<p>No tiene permisos de ver esta página. <a href='loging.php'>Iniciar sesión</a><p>";
    exit();
}
?>
<!DOCTYPE html>
...
<body class="container mt-3">
    ...
    <p><span class="badge text-bg-primary">Usuario: <?php echo $_SESSION['user']; ?></span> <a href="salir.php">Cerrar
            sesión</a></p>
</body>
